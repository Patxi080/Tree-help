...
/**
 * Clase que modifica el código de MonticuloBinarioR0 para que empieza a numerar desde 
 * una raíz 0 en lugar de una raíz 1.
 * 
 * @author J.Goerlich
 * @version 26/04/2023
 */
public class MonticuloBinarioR0<E extends Comparable<E>> implements ColaPrioridad<E>{
    ...
    public void insertar(E e) {
        // if (talla == elArray.length - 1) { duplicarArray(); } //Array completo
        // int  posIns = talla++;
